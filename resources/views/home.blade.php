    ...
    @auth
        ...
        <div class="p-8 max-w-screen-lg mx-auto bg-green-100 rounded-md shadow-md mt-10 ">
          ...
          <form action="/create-post" method="POST">
              ...
              <input name="title" type="text" placeholder="Title" class="w-full px-4 py-2 mb-4 border border-gray-300 rounded-md focus:outline-none focus:border-green-700">
              <textarea name="body" id="body" rows="10" placeholder="Body content..." class="w-full px-4 py-2 mb-4 border border-gray-300 rounded-md focus:outline-none focus:border-green-700"></textarea>
              <button type="submit" class="w-full bg-green-700 text-white py-2 rounded-md hover:bg-green-800 focus:outline-none focus:shadow-outline-green">Create new post</button>
          </form>
      </div>
